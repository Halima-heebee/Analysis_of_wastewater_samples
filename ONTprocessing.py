...
# for e in ont_dir:
#     print(e)
#     os.chdir(f"/home/mbxha18/allcombinations/kit14/10.4_SUP_PROM_VARSCAN/NT001_super_barcoded/{e}/")
#     os.system(f"artic guppyplex --min-length 80 --max-length 480 --directory . --prefix guppyplexed.{e}")



# #Read in the bigsamplesheet containing Nimagen indexes merged
# csv = pd.read_csv("/home/mbxha18/OvsI_prom10.4sup_onebarcode/UDI06samplesheet.txt", sep="\t")
...
# plates = []
# all_subdirs = [d for d in os.listdir('/home/mbxha18/allcombinations/kit14/10.4_SUP_PROM_VARSCAN/NT001_super_barcoded/') if d.startswith("NIMAGEN")]    #os.path.isdir(d)]
...
# # create a list of the NT001 illumina fastq and then a set of their well plate
# file_lists= []
...
# ont = [x for x in os.listdir('/home/mbxha18/allcombinations/kit14/10.4_SUP_PROM_VARSCAN/NT001_super_barcoded/')]
# ill = [x for x in os.listdir('/home/mbxha18/allcombinations/kit14/10.4_SUP_PROM_VARSCAN/ill_match/')]
# for b in ont:
#     for c in ill:
#         try:
#             if b[-4:] == c.split('-')[4]:
...
#     os.system(f"artic minion --normalise 1000000 --threads 4 --medaka --medaka-model r1041_e82_400bps_sup_g615 --scheme-directory /home/mbxha18/artic/fieldbioinformatics/test-data/primer-schemes --read-file guppyplexed.NIMAGEN{e[-4:]}_..fastq --fast5-directory /mnt/waterprom/NewRun/WWS_NT001_Synthetic/NT001/20230201_1620_2G_PAG69249_004a2eb5/fast5_pass --sequencing-summary /mnt/waterprom/NewRun/WWS_NT001_Synthetic/NT001/20230201_1620_2G_PAG69249_004a2eb5/sequencing_summary_PAG69249_004a2eb5_6e58e143.txt nCoV-2019/V9 artic.10.4_HAC_PROM.{e}")
...
for e in ill_dir:
    print(e)
    os.chdir(f'/home/mbxha18/allcombinations/kit14/10.4_SUP_PROM_VARSCAN/ill_match/{e}')
    os.system(f"samtools mpileup -f /home/mbxha18/artic/fieldbioinformatics/test-data/primer-schemes/nCoV-2019/V9/nCoV-2019.reference.fasta -q 10 -d 1000000 Kit14.artic.10.4_SUP_PROM.{e}.primertrimmed.rg.sorted.bam > {e}.ont.pileup")
    os.system(f"varscan pileup2snp {e}.ont.pileup --min-var-freq 0.01  --p-value 1 --min-coverage 1 --min-reads2 1 > {e}.ont.mincov1.varscan.tsv")
    os.system(f"varscan pileup2snp {e}.ont.pileup --min-var-freq 0.01 --min-coverage 8 > {e}.ont.mincov8.minvar0.01.varscan.tsv")
    os.system(f"varscan pileup2snp {e}.ont.pileup --min-var-freq 0.02 --min-coverage 8 > {e}.ont.mincov8.minvar0.02.varscan.tsv")
    os.system(f"varscan pileup2snp {e}.ont.pileup --min-var-freq 0.03 --min-coverage 8 > {e}.ont.mincov8.minvar0.03.varscan.tsv")
    os.system(f"mosdepth --no-per-base {e}.ont Kit14.artic.10.4_SUP_PROM.{e}.primertrimmed.rg.sorted.bam")
    os.system(f"samtools depth -aa Kit14.artic.10.4_SUP_PROM.{e}.primertrimmed.rg.sorted.bam > {e}.ont.samtools.cov ")
